...
3. **`.kerby/STATUS.md` created** from the engine template — position only (phase, what is queued, what is stuck). Read `references/communication.md` § Status Tracking first: no version, SHA, branch, completion history or count belongs in it
