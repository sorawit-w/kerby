...
| Independent-model Codex review (`@codex review` on the PR) | author framing | **HARD for any rule-text change** — empirically catches internal contradictions both audits miss |
